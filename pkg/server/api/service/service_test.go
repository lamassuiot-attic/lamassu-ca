...
import (
	...
	"github.com/lamassuiot/lamassu-ca/pkg/server/mocks"
...
func TestImportCA(t *testing.T) {
	...
	caType, _ := secrets.ParseCAType("pki")
	//s := ""
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("Testing %s", tc.name), func(t *testing.T) {
			...
			a, err := srv.ImportCA(ctx, caType, tc.caName, tc.cert, keyM, 1000)
			fmt.Printf("a: %v\n", a)
...
func TestGetCert(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Empty serial number", certEmptySN, secrets.Cert{}, errors.New("empty serial number")},
	}
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("Testing %s", tc.name), func(t *testing.T) {
...
func TestGetIssuedCerts(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(fmt.Sprintf("Testing %s", tc.name), func(t *testing.T) {
			...
			_, err := srv.GetIssuedCerts(ctx, caType, newCA.Name)
			if err != nil {
				if err.Error() != tc.ret.Error() {
					t.Errorf("Got result is %s; want %s", err, tc.ret)
				}
...
func TestCreateCA(t *testing.T) {
	...
	testCases := []struct {
		...
		{"Create empty", secrets.Cert{}, secrets.Cert{}, errors.New("resource already exists. resource_type=CA resource_id=")},
	}
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("Testing %s", tc.name), func(t *testing.T) {
			keyMetadata := secrets.PrivateKeyMetadata{
...
func TestDeleteCert(t *testing.T) {
	...
	newCAI, err := srv.CreateCA(ctx, caType, "testDCMockIn", keyMetadata, certReq.Subject, certReq.CaTTL, certReq.EnrollerTTL)
	...
	testCases := []struct {
		...
		{"Delete deleted CA", newCAI, errors.New("could not revoke cert from CA")},
		{"Delete certificate", newCA, nil},
	}
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("Testing %s", tc.name), func(t *testing.T) {
			num := utils.InsertNth(utils.ToHexInt(crt.SerialNumber), 2)
